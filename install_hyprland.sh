...
sudo pacman -Syuu
sudo pacman -S network-manager-applet dialog wpa_supplicant bluez bluez-utils xdg-user-dirs pulseaudio pavucontrol feh playerctl archlinux-keyring

sudo pacman -S ttf-dejavu polybar rofi kitty firefox vlc parted gparted lxappearance xclip
