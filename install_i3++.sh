...
sudo pacman -Syuu
sudo pacman -S network-manager-applet dialog wpa_supplicant bluez bluez-utils xdg-user-dirs pulseaudio pavucontrol alsa alsa-utils sxiv nitrogen playerctl
sudo pacman -S xorg xorg-xinit
sudo cp /etc/X11/xinit/xinitrc ~/.xinitrc

sudo pacman -S i3-gaps i3lock i3status ttf-dejavu polybar dmenu kitty opera opera-ffmpeg-codecs lxsession neofetch vlc parted gparted lxappearance
yay -S pfetch
...
sudo pacman -S noto-fonts-cjk noto-fonts-emoji noto-fonts ttf-liberation ttf-font-awesome
